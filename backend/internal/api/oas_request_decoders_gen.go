...
func (s *Server) decodeOrderDeviceRequest(r *http.Request) (
	req *OrderDeviceReq,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeReviewOrderByIdRequest(r *http.Request) (
	req *ReviewOrderByIdReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request ReviewOrderByIdReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
